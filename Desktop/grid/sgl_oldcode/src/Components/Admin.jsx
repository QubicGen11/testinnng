    ...
    try {
      ...
      await axios.all([
        ...
        axios.post('http://localhost:8083/api/admin/form-defaults', {
          ...defaultSettings,
          title: defaultSettings.title,  // Ensure title is included
          feedbackQuestions: customQuestions,
          titleOptions,
          newsletterOptions,
          clientType,  // Save client type
        }, {
          headers: {
            Authorization: `Bearer ${token}`
          }
            ...
            <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
              <div className="bg-white p-4 rounded shadow-md h-[60vh] w-[60vw] overflow-y-auto">
                <h2 className="text-xl font-bold mb-4 text-black">
                  {clientType === 'Individual' ? 'Client Details' : 'Company Details'}
                </h2>
                ...
                <div className="mb-8">
                  <div className="flex space-x-4 mb-4">
                    <button
                      ...
                      className={`bg-blue-500 text-white px-4 py-2 rounded-md ${clientType === 'Individual' ? 'bg-blue-700' : ''}`}
                    >
                      Individual
                    </button>
                    <button
                      onClick={() => handleClientTypeChange('Corporate')}
                      className={`bg-blue-500 text-white px-4 py-2 rounded-md ${clientType === 'Corporate' ? 'bg-blue-700' : ''}`}
                    >
                      Corporate
                    </button>
                  </div>
          ...
          <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-8 rounded shadow-md w-3/4 h-3/4 overflow-y-auto">
              ...
              <Form
                ...
                clientType={clientType} // Pass client type to the form
              />
              <div className="flex justify-end mt-4">
                <button
