...
const FeedbackDetails = () => {
  ...
  const exportAllToExcel = () => {
    ...
    const feedbackData = dataToExport.map(feedback => {
      const customResponses = feedback.customResponses ? Object.keys(feedback.customResponses).reduce((acc, question) => {
        acc[question] = feedback.customResponses[question];
        return acc;
      }, {}) : {};
      ...
      return {
        ...
        Newsletter: feedback.newsletterSubscribe ? 'Yes' : 'No',
        ...customResponses, // Add custom responses as individual columns
      };
    });
